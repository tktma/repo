...
|:-------------------------|:-------------|:-------------|------|
| CustomCojang | 내가 수정함 끼얏호우웅 |[![Deploy To Azure](https://learn.microsoft.com/en-us/azure/templates/media/deploy-to-azure.svg)](https://portal.azure.com/#blade/Microsoft_Azure_CreateUIDef/CustomDeploymentBlade/uri/https://github.com/tktma/repo/blob/main/eslzArm/eslzArm.json/uiFormDefinitionUri/https://github.com/tktma/repo/blob/main/eslzArm/eslz-portal.json) | [Detailed description](./docs/reference/contoso/Readme.md) |
